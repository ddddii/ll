...
from pyrogram.raw.base.messages import InactiveChats
from pyrogram.raw.functions.channels import GetChannels, GetInactiveChannels
from pyrogram.raw.types import InputChatlistDialogFilter
from database import *
from pyrogram.utils import get_peer_id
from pyrogram.raw.base import input_peer, InputChannel
from pyrogram.raw.functions.messages import AddChatUser

opreat      = sys.argv[1];
opreats    = ['addusers','join','left','check','send','getusers','leavess','adduser','getUsers','joining','CX','MovePro','View','AddUser','joinlist','leavelist'];
...
async def Controll():
		...
		try:
			...
			async for foundN in getNotFoundUsers:
				...
				if foundN.user.username is not None:
					a = await app.get_users(str(foundN.user.username))
					b = a.is_premium
					if b == True:
	...
	##				print("Channel ID:", dialog.chat.id)
